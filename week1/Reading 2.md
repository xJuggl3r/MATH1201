...
Lets begin by multiplying a complex number by a real number. We distribute the real number just as we would with
a binomial.
...
**Often the easiest method of solving a quadratic equation is factoring. *Factoring* means *finding expressions that can
